...
public class MyTimer implements Runnable
{
	...
	// initialize the duration of the timer to millis milliseconds.  Recall
	// that 1000 milliseconds = 1 second.
	...
	// This method will stop the timer.  This can be used in case the task is
	// finished prior to the timer running out.  In Assignment 2 this could be
	// if the player completes all of the edits in less than a minute.
