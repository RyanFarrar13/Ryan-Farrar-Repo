...
// the SimpleLList is empty (special case) return the String
// "List is empty".
	...
	if (curr!=null){
		SB.append(curr.data);
			...
			curr = curr.next;
				SB.append(curr.data);
				SB.append(" ");
				//Need to acces inside info in node
	...
	public boolean equals(SimpleLList arg){// Return true if the data
// in SimpleLList arg exactly matches the data in the current
// SimpleLList. All Strings must match in the order stored.
// Return false otherwise.
    Node curr1 = arg.front;
   Node curr = front;
   StringBuilder SB = new StringBuilder("");
