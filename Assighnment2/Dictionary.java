...
// Use this class to get new random words for your word Edit Distance program
// and to test words to see if they are in the dictionary.  A Dictionary can
// also be used to store the answers for a user in the game.

// This class also contains a static method to calculate the Levenshtein
// distance between to words.  You will also need to use this method in your
// main program.
...
// to know these details in order to to use this class.  We may look over
